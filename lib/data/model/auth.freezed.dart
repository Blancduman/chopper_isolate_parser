...
class _$AuthTearOff {
  ...
  _Auth call({@JsonKey(name: 'access_token') String? token}) {
    return _Auth(
      token: token,
    );
  }
...
class _$_Auth with DiagnosticableTreeMixin implements _Auth {
  const _$_Auth({@JsonKey(name: 'access_token') this.token});
...
abstract class _Auth implements Auth {
  const factory _Auth({@JsonKey(name: 'access_token') String? token}) = _$_Auth;
